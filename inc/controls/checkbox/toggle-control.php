...
class Customizer_Toggle_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'customizer-toggle-control', plugins_url( '/js/customizer-toggle-control.js', __FILE__ ), array( 'jquery' ), time(), true );
		wp_enqueue_style( 'pure-css-toggle-buttons', plugins_url( '/pure-css-toggle-buttons.css', __FILE__ ), array(), time() );
